...
pub trait StorageList {
    ...
    fn blpop(&mut self, keys: Vec<String>, token: mio::Token, timeout: u32) -> Option<Vec<String>>;
    fn brpop(&mut self, keys: Vec<String>, token: mio::Token, timeout: u32) -> Option<Vec<String>>;
}